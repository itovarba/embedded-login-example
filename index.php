...
<html lang="en">
  <head>
    ...
    <title>FIX, curated coffee components Iberia Identity Labs</title>
    ...
    <meta name="salesforce-redirect-uri" content="<?php echo getenv('SALESFORCE_CALLBACK_URL');?>">
	...
	<link href="<?php echo getenv('SALESFORCE_COMMUNITY_URL');?>/servlet/servlet.loginwidgetcontroller?type=css" rel="stylesheet" type="text/css" />
